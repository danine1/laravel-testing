...
// alternative methods for routing, same 
/*<?php echo route( name: 'route_homepage') ?>

<?php echo action( name: 'HomeController@index') ?>

<?php echo action( name: 'OceanController@show', ['atlantic']) ?>

<?php echo action( name: 'OceanController@show', ['pacific']) ?>*/
?>
...
<body>
    ...
    <section class="list">
        <div>
            ...
            <ul>
                <li>
                <a href="<?php echo route('ocean detail', ['name' => 'arctic']); ?>">Arctic Ocean</a>
                </li>
                <li>
                 <a href="<?php echo route('ocean detail', ['name' => 'atlantic']); ?>">Atlantic Ocean</a> 
                </li>
                <li>
                <a href="<?php echo route('ocean detail', ['name' => 'indian']); ?>">Indian Ocean</a>
                </li>
                <li>
                <a href="<?php echo route('ocean detail', ['name' => 'pacific']); ?>">Pacific Ocean</a>
                </li>
                <li>
                    <a href="<?php echo route('ocean detail', ['name' => 'southern']); ?>">Southern Ocean</a>
                </li>
            </ul>
        </div>
    </section>
